        ...
        <div className="bg-white rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-14 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-black/5 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <div className="grid gap-12 text-base leading-loose">
              {[
                ...
                { 
                  ...
                  content: "All products listed on the website, their descriptions, and their prices are subject to change. We reserve the right to modify, suspend, or discontinue the sale of any product at any time without notice." 
                },
                { 
                  title: "4. Orders and Payment", 
                  content: "We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order." 
                },
                { 
                  title: "5. Shipping and Delivery", 
                  content: "Shipping costs and delivery times vary depending on your location. We are not responsible for any delays caused by the shipping carrier." 
                },
                { 
                  title: "6. Returns and Refunds", 
                  content: "Please refer to our Refund and Returned policy for detailed information on how to return products and request refunds." 
                },
                { 
            ...
            <div className="mt-16 pt-8 border-t border-gray-100 flex justify-center">
              <span className="text-[10px] bg-purple-50 text-purple-600 px-4 py-2 rounded-full font-bold uppercase tracking-widest">Effective Date: March 2026</span>
            </div>
          </div>
        </div>
      </div>
