            ...
            <div className="space-y-12">
              <section>
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-xs font-black text-emerald-500 uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full">01</span>
                  <h2 className="text-xl font-bold text-[#0B1221] m-0">Information We Collect</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-xs font-black text-emerald-500 uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full">02</span>
                  <h2 className="text-xl font-bold text-[#0B1221] m-0">How We Use Your Information</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-xs font-black text-emerald-500 uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full">03</span>
                  <h2 className="text-xl font-bold text-[#0B1221] m-0">Information Sharing</h2>
                </div>
                <p className="text-base leading-loose">
              ...
              <section>
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-xs font-black text-emerald-500 uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full">04</span>
                  <h2 className="text-xl font-bold text-[#0B1221] m-0">Data Security</h2>
                </div>
                <p className="text-base leading-loose">
              ...
              <section>
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-xs font-black text-emerald-500 uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full">05</span>
                  <h2 className="text-xl font-bold text-[#0B1221] m-0">Contact & Rights</h2>
                </div>
                <p className="text-base leading-loose">
                  You have the right to access, correct, or delete your personal data. If you have any questions, please contact us at <a href="mailto:cc.believerssign@gmail.com" className="text-blue-600 hover:text-blue-700 font-bold no-underline">cc.believerssign@gmail.com</a> or call us at <a href="tel:09638090000" className="text-blue-600 hover:text-blue-700 font-bold no-underline">09638-090000</a>.
                </p>
              </section>
            </div>

            <div className="mt-16 pt-8 border-t border-gray-100 flex items-center justify-between">
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Version 1.0</span>
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Last updated: March 2026</span>
            </div>
          </div>
        </div>
      </div>
