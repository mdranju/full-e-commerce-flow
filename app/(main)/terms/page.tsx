        ...
        <div className="bg-white rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-14 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-black/5 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="text-xl font-medium text-[#0B1221] leading-relaxed mb-12 pb-10 border-b border-gray-100">
              Welcome to Avlora Wear. These terms and conditions outline the
              ...
              {[
                {
                  ...
                  content:
                    "Do not continue to use Avlora Wear if you do not agree to take all of the terms and conditions stated on this page.",
                },
                {
                ...
                },
                {
                  ...
                  content:
                    "All content included on this site, such as text, graphics, logos, images, and software, is the property of Avlora Wear or its content suppliers and protected by international copyright laws.",
                },
              ].map((section, idx) => (
