          ...
          <div className="border border-gray-200 p-6 rounded-lg bg-gray-50 sticky top-24">
            ...
            {cartItems.map((item, idx) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="relative w-12 h-16 bg-white rounded shrink-0 border border-gray-100">
                    <Image
                      src={item.image}
                      alt={item.name}
                      fill
            ...
            <div className="border-b border-gray-200 pb-4 mb-4">
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm cursor-pointer hover:bg-gray-100 px-2 py-1 rounded transition-colors -ml-2">
                  <input
                    type="radio"
                    name="shipping"
                  ...
                  />
                  <span>
                    Inside Dhaka: <span className="font-medium">60৳</span>
                  </span>
                </label>
                <label className="flex items-center gap-2 text-sm cursor-pointer hover:bg-gray-100 px-2 py-1 rounded transition-colors -ml-2">
                  <input
                  ...
                  />
                  <span>
                    Outside Dhaka: <span className="font-medium">120৳</span>
                  </span>
                </label>
              </div>
            </div>
            ...
            <div className="mb-6">
              <label className="flex items-start gap-2 text-sm cursor-pointer">
                <input
                  type="radio"
                  name="payment"
                  className="mt-1 text-black focus:ring-black accent-black"
                  defaultChecked
                />
                <div>
