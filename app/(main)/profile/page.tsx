            ...
            {!showForm && (
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {profileActions.map((action, idx) => {
                    ...
                    return (
                      <Link
                        key={action.name}
                        href={action.href}
                        className={`group relative glass-card p-8 rounded-[2.5rem] border border-black/5 bg-white overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-black/5 hover:-translate-y-2 flex flex-col items-start ${
                          action.mobileOnly ? "lg:hidden" : ""
                        }`}
                        style={{ animationDelay: `${idx * 100}ms` }}
                      >
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-700 mb-6 ${action.bg} ${action.color} group-hover:scale-110 group-hover:shadow-2xl`}>
                  ...
                  <button className="group relative glass-card p-8 rounded-[2.5rem] border border-red-500/10 bg-red-50/10 transition-all duration-500 hover:bg-red-50 hover:shadow-2xl hover:shadow-red-500/5 hover:-translate-y-2 text-left">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-sm font-black text-red-600 tracking-tight uppercase">Log Out</h3>
                        <p className="text-[9px] font-black uppercase tracking-widest text-red-300">Sign out of your account</p>
                    </div>
                  </button>
                </div>
              </div>
            ...
            {showForm && (
              <div className="glass-card rounded-[3.5rem] border border-black/5 bg-white p-10 lg:p-16 animate-in slide-in-from-bottom-12 duration-700 shadow-2xl shadow-black/5">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
                  <div>
                      <p className="text-blue-600 text-[10px] font-black tracking-[0.4em] uppercase mb-4">Edit Profile Info</p>
