          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <div className="space-y-12">
              <section className="bg-rose-50/30 p-8 rounded-3xl border border-rose-100/50">
                <h2 className="text-lg font-black text-rose-600 uppercase tracking-widest mt-0 mb-6">
              ...
              <section>
                <h2 className="text-xl font-bold text-[#0B1221] mt-0 mb-4">
              ...
              <section className="border-l-4 border-gray-200 pl-6 my-8">
                <h2 className="text-xl font-bold text-[#0B1221] mt-0 mb-3">
              ...
              <section>
                ...
                <div className="space-y-6 text-base leading-loose text-gray-600">
                  <p className="m-0">
                    Once your return is inspected, we will notify you of the
                    approval or rejection of your refund. If approved, your
                    refund will be processed to the original method of payment
                    automatically.
                  </p>
                  <p className="m-0">
                    <strong>Late Refunds:</strong> Check your bank account,
                    contact your credit card company, then contact your bank. If
                    still unresolved, email us.
                  </p>
                  <p className="m-0">
                    <strong>Exchanges:</strong> We only replace items if they
              ...
              <section className="bg-gray-900 text-white p-8 rounded-3xl">
                <h2 className="text-lg font-black text-white uppercase tracking-widest mt-0 mb-4">
                  5. Shipping Costs
                </h2>
