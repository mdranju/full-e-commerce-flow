...
export default function CategoriesPage() {
  return (
    <div className="min-h-screen bg-[#f8fafc]/50">
      {/* 1. Category Hero */}
      <div className="relative h-[45vh] lg:h-[65vh] flex items-center justify-center overflow-hidden bg-[#0B1221]">
            ...
            >
              ...
              <div className="relative z-10 w-full space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <ChevronRight size={20} className="text-[#0B1221]/20 group-hover:text-blue-600 group-hover:translate-x-2 transition-all duration-700" strokeWidth={1.5} />
                </div>
